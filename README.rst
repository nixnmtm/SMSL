...
.. |commits-since| image:: https://img.shields.io/github/commits-since/tclick/python-fluctmatch/v3.1.6.svg
    :alt: Commits since latest release
    :target: https://github.com/tclick/python-fluctmatch/compare/v3.1.6...master
