...
.. |commits-since| image:: https://img.shields.io/github/commits-since/tclick/python-fluctmatch/v3.2.1.svg
    :alt: Commits since latest release
    :target: https://github.com/tclick/python-fluctmatch/compare/v3.2.1...master
