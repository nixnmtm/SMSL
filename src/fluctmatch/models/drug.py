...
class PolarN3(ModelBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._mapping["N1"] = "resname N3P and name N1"
        ...
        self._mapping["O5"] = "resname N3P and name O11"
